...
async function cleanup(organizationIds: string[]): Promise<void> {
  ...
  await prisma.$transaction([
    ...
    prisma.credentialRecord.deleteMany({ where }),
    prisma.activation.deleteMany({ where }),
    prisma.provisioningAttempt.deleteMany({ where }),
    prisma.trial.deleteMany({ where }),
    prisma.fulfillment.deleteMany({ where }),
    prisma.providerProductMapping.deleteMany({ where }),
    prisma.provider.deleteMany({ where }),
