...
La atribución original, el estado conversacional, razones y cadencia de
seguimiento de Marketing v2.9 se consultan dentro del mismo tenant. Sus
referencias no aceptan `organizationId` desde el cliente.
